...
const iconList=[icons.Walk, icons.Running, icons.Backpacker, icons.Bike, icons.Swimmer];
const iconList2=[icons.Walk, icons.Dog, icons.Teacher, icons.Couple, icons.Team];
